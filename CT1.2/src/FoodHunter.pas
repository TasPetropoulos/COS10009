...
begin
    ...
    // Recorded by Mike Koenig - http://soundbible.com/573-Mmm-Woman-Sensual.html
    LoadSoundEffectNamed('Yum', 'Mmm Woman Sensual-SoundBible.com-1076641667.wav');
    // Recorded by Mike Koenig - http://soundbible.com/629-Little-Girl-Sigh.html
    LoadSoundEffectNamed('Yuk', 'Little Girl Sigh-SoundBible.com-2035045030.wav');
end;
